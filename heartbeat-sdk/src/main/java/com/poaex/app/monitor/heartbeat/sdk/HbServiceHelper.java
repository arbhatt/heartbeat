...
public class HbServiceHelper {
    ...
    public static String putApi(String url, String jsonInput) {
    ...
    public static String postApi(String url, String jsonInput) {
        ...
        try {
            ...
            log.error("Unable to make a call to " + url + " with data " + jsonInput, e);
        } finally {
            try {
                httpClient.close();
            } catch (IOException e) {
    ...
    public static String getApi(String url, Map<String, String> params) {
        ...
        try {
            ...
            log.error("Unable to make a call to service", e);
            log.error("Unable to make a call to " + url , e);
        } finally {
            try {
                httpClient.close();
            } catch (IOException e) {
